...
const FunctionPayments = (props) => {

    let { paymentsData = [], count, handleDecrement, handleIncrement, handleReset } = props, 
        ...
        <>
            <div className="eshop-div payments-div">
                ...
                {count > 0 && paymentsData.length > 0 && (
                    <>
                        <h2>Product Name: <span>{product.pname && product.pname}</span></h2>
                        {/* <img className='product-img' src={productImage} alt={productImage} /> */}
                        <h3>Total Price: <span>₹ {count * (product.pprice && product.pprice)} /-</span></h3>
                        <h3>Product Desc.: <span>{product.pdesc && product.pdesc}</span></h3>
                        <h3> {count} </h3>
...
export default FunctionPayments;