    ...
    render() {
        ...
        return (
            <>
                ...
                <ClassChildren paymentsData={productsData} count={count} handleDecrement={this.props.handleDecrement} 
                    handleReset={this.props.handleReset} handleIncrement={this.props.handleIncrement}/>
            </>
        );
    }
}